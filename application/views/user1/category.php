		        ...
		        <div class="row">
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img01.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img11.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img08.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img13.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img15.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img03.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <article class="col-md-12 article-list">
		            <div class="inner">
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img16.jpg">
		                </a>
		              </figure>
		              <div class="details">
		                <div class="detail">
		          ...
		          <div class="aside-body">
		            <article class="article-fw">
		              <div class="inner">
		                <figure>
			                <a href="single.php">
			                  <img src="<?php echo base_url('public/user2/'); ?>images/news/img12.jpg">
			                </a>
		                </figure>
		                <div class="details">
		            ...
		            <article class="article-mini">
		              ...
		              <figure>
			              <a href="single.php">
			                <img src="<?php echo base_url('public/user2/'); ?>images/news/img05.jpg">
		                </a>
		              </figure>
		              <div class="padding">
		            ...
		            <article class="article-mini">
		              <div class="inner">
		                <figure>
			                <a href="single.php">
			                  <img src="<?php echo base_url('public/user2/'); ?>images/news/img02.jpg">
		                  </a>
		                </figure>
		                <div class="padding">
