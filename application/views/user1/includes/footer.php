						...
						<div class="block">
							...
							<div class="block-body">
								<figure class="foot-logo">
									<img src="<?php echo base_url('public/user2/'); ?>images/logo-light.png" class="img-responsive" alt="Logo">
								</figure>
							...
							<div class="block-body">
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="<?php echo base_url('public/user2/'); ?>images/news/img12.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
